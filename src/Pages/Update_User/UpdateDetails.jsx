  ...
  const getUserData = async () => {
    try {
      const { data } = await axios.get(
        `http://206.189.135.103:5000/api/getUserDetails`,
        {
          headers: {
      ...
      userDetails.firstName = data.user.firstName;
      userDetails.lastName = data.user.lastName;
      userDetails.email = data.user.email;
      userDetails.phoneNumber = data.user.phoneNumber;
      userDetails.address = data.user.address;
      userDetails.zipCode = data.user.zipCode;
      userDetails.city = data.user.city;
      userDetails.userState = data.user.userState;
      setUserData(data);
    } catch (error) {
